export default function MovieDetailSkeleton() {
  return (
    <section className="flex justify-center items-start gap-10 w-full max-w-6xl mx-auto mt-24 p-8 animate-pulse">
      <div className="w-[300px] aspect-[2/3] bg-(--skeleton-bg-secondary) rounded shadow-lg" />
      <div className="flex flex-col gap-6 flex-1">
        ...
        <div className="bg-(--skeleton-bg-primary) p-4 rounded text-sm leading-relaxed space-y-2">
